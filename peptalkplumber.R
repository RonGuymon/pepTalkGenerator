library(plumber)
# This file can be run from RStudio to test it out, but it is
# not what you would deploy.
myList <- list(p1 = c("Champ,", "Fact:", "Everybody says", "Dang...", "Check it:", "Just saying...", "Superstar,", "Tiger,", "Self,", "Know this:", "News alert:", "Girl,", "Bro,", "Ace,", "Excuse me but", "Experts agree:", "In my opinion,", "Hear ye, hear ye:", "Okay, listen up:")
